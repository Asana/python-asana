...
------------- | ------------- | -------------
[**add_custom_field_setting_for_goal**](GoalsApi.md#add_custom_field_setting_for_goal) | **POST** /goals/{goal_gid}/addCustomFieldSetting | Add a custom field to a goal
...
[**remove_custom_field_setting_for_goal**](GoalsApi.md#remove_custom_field_setting_for_goal) | **POST** /goals/{goal_gid}/removeCustomFieldSetting | Remove a custom field from a goal
