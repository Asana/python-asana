 ...
 **custom_type** | **str**| Filter results by custom type. Provide a custom type GID to return only objects of that custom type (an unknown GID returns &#x60;400&#x60;). Provide an empty string to return only objects with no custom type assigned. If this parameter is omitted, results are not filtered by custom type. | [optional] 
 **opt_fields** | **Dict**| This endpoint returns a resource which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include. | [optional] 
 ...
 **assignee.any** | **str**| Comma-separated list of user identifiers. This can either be the string \&quot;me\&quot;, an email, or the gid of a user. | [optional] 
 **assignee.not** | **str**| Comma-separated list of user identifiers. This can either be the string \&quot;me\&quot;, an email, or the gid of a user. | [optional] 
 **portfolios.any** | **str**| Comma-separated list of portfolio IDs | [optional] 
 **projects.any** | **str**| Comma-separated list of project IDs. Returns tasks that are directly in these projects or inherit them from an ancestor task. | [optional] 
 ...
 **followers.any** | **str**| Comma-separated list of user identifiers. This can either be the string \&quot;me\&quot;, an email, or the gid of a user. | [optional] 
 **followers.not** | **str**| Comma-separated list of user identifiers. This can either be the string \&quot;me\&quot;, an email, or the gid of a user. | [optional] 
 **created_by.any** | **str**| Comma-separated list of user identifiers. This can either be the string \&quot;me\&quot;, an email, or the gid of a user. | [optional] 
 **created_by.not** | **str**| Comma-separated list of user identifiers. This can either be the string \&quot;me\&quot;, an email, or the gid of a user. | [optional] 
 **assigned_by.any** | **str**| Comma-separated list of user identifiers. This can either be the string \&quot;me\&quot;, an email, or the gid of a user. | [optional] 
 **assigned_by.not** | **str**| Comma-separated list of user identifiers. This can either be the string \&quot;me\&quot;, an email, or the gid of a user. | [optional] 
 **liked_by.not** | **str**| Comma-separated list of user identifiers. This can either be the string \&quot;me\&quot;, an email, or the gid of a user. | [optional] 
 **commented_on_by.not** | **str**| Comma-separated list of user identifiers. This can either be the string \&quot;me\&quot;, an email, or the gid of a user. | [optional] 
 ...
 **sort_by** | **str**| One of &#x60;due_date&#x60;, &#x60;created_at&#x60;, &#x60;completed_at&#x60;, &#x60;likes&#x60;, &#x60;relevance&#x60;, or &#x60;modified_at&#x60;, defaults to &#x60;modified_at&#x60; | [optional] [default to modified_at]
