...
**name** | **str** | The name of the date variable. | [optional] 
**description** | **str** | The description of what the date variable is used for when instantiating a project. | [optional] 
