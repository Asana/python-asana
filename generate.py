...
for resource_name, resource in api['resources'].iteritems():
    ...
    resource_base_py = open('asana/resources/' + module_name_base + '.py', 'w')
    ...
    if not os.path.exists('asana/resources/' + module_name + '.py'):
        resource_py = open('asana/resources/' + module_name + '.py', 'w')
...
init_py.write(INIT_PY_TEMPLATE.substitute(resource_names=', '.join(resource_names)))
init_py.close()
