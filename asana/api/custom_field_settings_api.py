...
class CustomFieldSettingsApi(object):
    ...
    def get_custom_field_settings_for_goal(self, goal_gid, opts, **kwargs):  # noqa: E501
        """Get a goal's custom fields  # noqa: E501
        ...
        >>> thread = api.get_custom_field_settings_for_goal(goal_gid, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_custom_field_settings_for_goal_with_http_info(goal_gid, opts, **kwargs)  # noqa: E501
        else:
            (data) = self.get_custom_field_settings_for_goal_with_http_info(goal_gid, opts, **kwargs)  # noqa: E501
            return data

    def get_custom_field_settings_for_goal_with_http_info(self, goal_gid, opts, **kwargs):  # noqa: E501
        """Get a goal's custom fields  # noqa: E501

        <b>Required scope: </b><code>goals:read</code>  Returns a list of all of the custom fields settings on a goal, in compact form. Note that, as in all queries to collections which return compact representation, `opt_fields` can be used to include more data than is returned in the compact representation. See the [documentation for input/output options](https://developers.asana.com/docs/inputoutput-options) for more information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_custom_field_settings_for_goal_with_http_info(goal_gid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_custom_field_settings_for_goal" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'goal_gid' is set
        if (goal_gid is None):
            raise ValueError("Missing the required parameter `goal_gid` when calling `get_custom_field_settings_for_goal`")  # noqa: E501
        ...
        if kwargs.get("full_payload", False) is True or kwargs.get('async_req', False) is True:
            ...
            return PageIterator(
                self.api_client,
                {
                    "resource_path": '/goals/{goal_gid}/custom_field_settings',
                    "method": 'GET',
    ...
    def get_custom_field_settings_for_portfolio(self, portfolio_gid, opts, **kwargs):  # noqa: E501
        ...
        <b>Required scope: </b><code>portfolios:read</code>  Returns a list of all of the custom fields settings on a portfolio, in compact form.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_custom_field_settings_for_team(self, team_gid, opts, **kwargs):  # noqa: E501
        """Get a team's custom fields  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_custom_field_settings_for_team(team_gid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = kwargs.get("_return_http_data_only", True)
        if kwargs.get('async_req'):
            return self.get_custom_field_settings_for_team_with_http_info(team_gid, opts, **kwargs)  # noqa: E501
        else:
            (data) = self.get_custom_field_settings_for_team_with_http_info(team_gid, opts, **kwargs)  # noqa: E501
            return data

    def get_custom_field_settings_for_team_with_http_info(self, team_gid, opts, **kwargs):  # noqa: E501
        """Get a team's custom fields  # noqa: E501

        <b>Required scope: </b><code>teams:read</code>  Returns a list of all of the custom fields settings on a team, in compact form. Note that, as in all queries to collections which return compact representation, `opt_fields` can be used to include more data than is returned in the compact representation. See the [documentation for input/output options](https://developers.asana.com/docs/inputoutput-options) for more information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_custom_field_settings_for_team_with_http_info(team_gid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_custom_field_settings_for_team" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'team_gid' is set
        if (team_gid is None):
            raise ValueError("Missing the required parameter `team_gid` when calling `get_custom_field_settings_for_team`")  # noqa: E501
        ...
        if kwargs.get("full_payload", False) is True or kwargs.get('async_req', False) is True:
            ...
            return PageIterator(
                self.api_client,
                {
                    "resource_path": '/teams/{team_gid}/custom_field_settings',
                    "method": 'GET',
                    "path_params": path_params,
                    "query_params": query_params,
                    "header_params": header_params,
