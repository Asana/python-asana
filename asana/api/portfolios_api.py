...
class PortfoliosApi(object):
    ...
    def duplicate_portfolio(self, portfolio_gid, opts, **kwargs):  # noqa: E501
        """Duplicate a portfolio  # noqa: E501

        <b>Required scope: </b><code>portfolios:write</code>  Creates and returns a job that will asynchronously handle the duplication.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.duplicate_portfolio(portfolio_gid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = kwargs.get("_return_http_data_only", True)
        if kwargs.get('async_req'):
            return self.duplicate_portfolio_with_http_info(portfolio_gid, opts, **kwargs)  # noqa: E501
        else:
            (data) = self.duplicate_portfolio_with_http_info(portfolio_gid, opts, **kwargs)  # noqa: E501
            return data

    def duplicate_portfolio_with_http_info(self, portfolio_gid, opts, **kwargs):  # noqa: E501
        """Duplicate a portfolio  # noqa: E501

        <b>Required scope: </b><code>portfolios:write</code>  Creates and returns a job that will asynchronously handle the duplication.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.duplicate_portfolio_with_http_info(portfolio_gid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method duplicate_portfolio" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'portfolio_gid' is set
        if (portfolio_gid is None):
            raise ValueError("Missing the required parameter `portfolio_gid` when calling `duplicate_portfolio`")  # noqa: E501
