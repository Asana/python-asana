...
class TasksApi(object):
    ...
    def search_tasks_for_workspace(self, workspace_gid, opts, **kwargs):  # noqa: E501
        ...
        :param str followers.any: Comma-separated list of user identifiers. This can either be the string \"me\", an email, or the gid of a user.
        :param str followers.not: Comma-separated list of user identifiers. This can either be the string \"me\", an email, or the gid of a user.
        :param str created_by.any: Comma-separated list of user identifiers. This can either be the string \"me\", an email, or the gid of a user.
        :param str created_by.not: Comma-separated list of user identifiers. This can either be the string \"me\", an email, or the gid of a user.
        :param str assigned_by.any: Comma-separated list of user identifiers. This can either be the string \"me\", an email, or the gid of a user.
        :param str assigned_by.not: Comma-separated list of user identifiers. This can either be the string \"me\", an email, or the gid of a user.
        :param str liked_by.not: Comma-separated list of user identifiers. This can either be the string \"me\", an email, or the gid of a user.
        :param str commented_on_by.not: Comma-separated list of user identifiers. This can either be the string \"me\", an email, or the gid of a user.
