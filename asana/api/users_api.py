...
class UsersApi(object):
    ...
    def get_user_for_workspace(self, workspace_gid, user_gid, opts, **kwargs):  # noqa: E501
        """Get a user in a workspace or organization  # noqa: E501

        <b>Required scope: </b><code>users:read</code>  Returns the full user record for the single user with the provided ID in the specified workspace or organization.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_for_workspace(workspace_gid, user_gid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = kwargs.get("_return_http_data_only", True)
        if kwargs.get('async_req'):
            return self.get_user_for_workspace_with_http_info(workspace_gid, user_gid, opts, **kwargs)  # noqa: E501
        else:
            (data) = self.get_user_for_workspace_with_http_info(workspace_gid, user_gid, opts, **kwargs)  # noqa: E501
            return data

    def get_user_for_workspace_with_http_info(self, workspace_gid, user_gid, opts, **kwargs):  # noqa: E501
        """Get a user in a workspace or organization  # noqa: E501

        <b>Required scope: </b><code>users:read</code>  Returns the full user record for the single user with the provided ID in the specified workspace or organization.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_for_workspace_with_http_info(workspace_gid, user_gid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_user_for_workspace" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'workspace_gid' is set
        if (workspace_gid is None):
            raise ValueError("Missing the required parameter `workspace_gid` when calling `get_user_for_workspace`")  # noqa: E501
        # verify the required parameter 'user_gid' is set
        if (user_gid is None):
            raise ValueError("Missing the required parameter `user_gid` when calling `get_user_for_workspace`")  # noqa: E501
    ...
    def update_user(self, body, user_gid, opts, **kwargs):  # noqa: E501
        """Update a user  # noqa: E501

        A specific, existing user can be updated by making a PUT request on the URL for that user. Only the fields provided in the `data` block will be updated; any unspecified fields will remain unchanged.  Returns the complete updated user record.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_user(body, user_gid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param dict body: The user to update. (required)
        :param str user_gid: A string identifying a user. This can either be the string \"me\", an email, or the gid of a user. (required)
        :param str workspace: The workspace to filter results on.
        :param list[str] opt_fields: This endpoint returns a resource which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include.
        :return: UserResponseData
        ...
        kwargs['_return_http_data_only'] = kwargs.get("_return_http_data_only", True)
        if kwargs.get('async_req'):
            return self.update_user_with_http_info(body, user_gid, opts, **kwargs)  # noqa: E501
        else:
            (data) = self.update_user_with_http_info(body, user_gid, opts, **kwargs)  # noqa: E501
            return data

    def update_user_with_http_info(self, body, user_gid, opts, **kwargs):  # noqa: E501
        """Update a user  # noqa: E501

        A specific, existing user can be updated by making a PUT request on the URL for that user. Only the fields provided in the `data` block will be updated; any unspecified fields will remain unchanged.  Returns the complete updated user record.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_user_with_http_info(body, user_gid, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'user_gid' is set
        if (user_gid is None):
            raise ValueError("Missing the required parameter `user_gid` when calling `update_user`")  # noqa: E501
    ...
    def update_user_for_workspace(self, body, workspace_gid, user_gid, opts, **kwargs):  # noqa: E501
        """Update a user in a workspace or organization  # noqa: E501

        An existing user can be updated by making a PUT request on the URL for that user in the specified workspace or organization. Only the fields provided in the `data` block will be updated; any unspecified fields will remain unchanged.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_user_for_workspace(body, workspace_gid, user_gid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = kwargs.get("_return_http_data_only", True)
        if kwargs.get('async_req'):
            return self.update_user_for_workspace_with_http_info(body, workspace_gid, user_gid, opts, **kwargs)  # noqa: E501
        else:
            (data) = self.update_user_for_workspace_with_http_info(body, workspace_gid, user_gid, opts, **kwargs)  # noqa: E501
            return data

    def update_user_for_workspace_with_http_info(self, body, workspace_gid, user_gid, opts, **kwargs):  # noqa: E501
        """Update a user in a workspace or organization  # noqa: E501

        An existing user can be updated by making a PUT request on the URL for that user in the specified workspace or organization. Only the fields provided in the `data` block will be updated; any unspecified fields will remain unchanged.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_user_for_workspace_with_http_info(body, workspace_gid, user_gid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_user_for_workspace" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if (body is None):
            raise ValueError("Missing the required parameter `body` when calling `update_user_for_workspace`")  # noqa: E501
        # verify the required parameter 'workspace_gid' is set
        if (workspace_gid is None):
            raise ValueError("Missing the required parameter `workspace_gid` when calling `update_user_for_workspace`")  # noqa: E501
        # verify the required parameter 'user_gid' is set
        if (user_gid is None):
            raise ValueError("Missing the required parameter `user_gid` when calling `update_user_for_workspace`")  # noqa: E501
