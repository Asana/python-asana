...
class WorkspaceMembershipsApi(object):
    ...
    def get_workspace_membership(self, workspace_membership_gid, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_workspace_membership_with_http_info(workspace_membership_gid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_workspace_membership_with_http_info(workspace_membership_gid, **kwargs)  # noqa: E501
            return data

    def get_workspace_membership_with_http_info(self, workspace_membership_gid, **kwargs):  # noqa: E501
        """Get a workspace membership  # noqa: E501
        ...
        all_params = ['workspace_membership_gid', 'opt_fields']  # noqa: E501
        ...
        if ('workspace_membership_gid' not in params or
                params['workspace_membership_gid'] is None):
            raise ValueError("Missing the required parameter `workspace_membership_gid` when calling `get_workspace_membership`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'workspace_membership_gid' in params:
            path_params['workspace_membership_gid'] = params['workspace_membership_gid']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='WorkspaceMembershipResponseData',  # noqa: E501
    ...
    def get_workspace_memberships_for_user(self, user_gid, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = kwargs.get("_return_http_data_only", True)
        if kwargs.get('async_req'):
            return self.get_workspace_memberships_for_user_with_http_info(user_gid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_workspace_memberships_for_user_with_http_info(user_gid, **kwargs)  # noqa: E501
            return data

    def get_workspace_memberships_for_user_with_http_info(self, user_gid, **kwargs):  # noqa: E501
        """Get workspace memberships for a user  # noqa: E501
        ...
        all_params = ['user_gid', 'limit', 'offset', 'opt_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('header_params')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='WorkspaceMembershipResponseArray',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_workspace_memberships_for_workspace(self, workspace_gid, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = kwargs.get("_return_http_data_only", True)
        if kwargs.get('async_req'):
            return self.get_workspace_memberships_for_workspace_with_http_info(workspace_gid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_workspace_memberships_for_workspace_with_http_info(workspace_gid, **kwargs)  # noqa: E501
            return data

    def get_workspace_memberships_for_workspace_with_http_info(self, workspace_gid, **kwargs):  # noqa: E501
        """Get the workspace memberships for a workspace  # noqa: E501
        ...
        all_params = ['workspace_gid', 'user', 'limit', 'offset', 'opt_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('header_params')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
