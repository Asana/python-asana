...
class TaskTemplatesApi(object):
    ...
    def get_task_template(self, task_template_gid, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_task_template_with_http_info(task_template_gid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_task_template_with_http_info(task_template_gid, **kwargs)  # noqa: E501
            return data

    def get_task_template_with_http_info(self, task_template_gid, **kwargs):  # noqa: E501
        """Get a task template  # noqa: E501
        ...
        all_params = ['task_template_gid', 'opt_fields']  # noqa: E501
        ...
        if ('task_template_gid' not in params or
                params['task_template_gid'] is None):
            raise ValueError("Missing the required parameter `task_template_gid` when calling `get_task_template`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'task_template_gid' in params:
            path_params['task_template_gid'] = params['task_template_gid']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='TaskTemplateResponseData',  # noqa: E501
    ...
    def get_task_templates_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['limit', 'offset', 'project', 'opt_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('header_params')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TaskTemplateResponseArray',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def instantiate_task(self, task_template_gid, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str task_template_gid: Globally unique identifier for the task template. (required)
        :param TaskTemplateGidInstantiateTaskBody body: Describes the inputs used for instantiating a task - the task's name.
        :param list[str] opt_fields: This endpoint returns a compact resource, which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include.
        ...
        kwargs['_return_http_data_only'] = kwargs.get("_return_http_data_only", True)
        if kwargs.get('async_req'):
            return self.instantiate_task_with_http_info(task_template_gid, **kwargs)  # noqa: E501
        else:
            (data) = self.instantiate_task_with_http_info(task_template_gid, **kwargs)  # noqa: E501
            return data

    def instantiate_task_with_http_info(self, task_template_gid, **kwargs):  # noqa: E501
        """Instantiate a task from a task template  # noqa: E501
        ...
        all_params = ['task_template_gid', 'body', 'opt_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('header_params')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
