...
class GoalMetricRequest(object):
    ...
    def __init__(self, gid=None, resource_type=None, resource_subtype=None, precision=None, unit=None, currency_code=None, initial_number_value=None, target_number_value=None, current_number_value=None, current_display_value=None, progress_source=None):  # noqa: E501
        """GoalMetricRequest - a model defined in Swagger"""  # noqa: E501
        self._gid = None
    ...
    @property
    def gid(self):
        """Gets the gid of this GoalMetricRequest.  # noqa: E501

        Globally unique identifier of the resource, as a string.  # noqa: E501

        :return: The gid of this GoalMetricRequest.  # noqa: E501
        :rtype: str
        """
        return self._gid
    ...
    @gid.setter
    def gid(self, gid):
        """Sets the gid of this GoalMetricRequest.

        Globally unique identifier of the resource, as a string.  # noqa: E501

        :param gid: The gid of this GoalMetricRequest.  # noqa: E501
        :type: str
        """
    ...
    def resource_type(self):
        """Gets the resource_type of this GoalMetricRequest.  # noqa: E501

        The base type of this resource.  # noqa: E501

        :return: The resource_type of this GoalMetricRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def resource_type(self, resource_type):
        """Sets the resource_type of this GoalMetricRequest.

        The base type of this resource.  # noqa: E501

        :param resource_type: The resource_type of this GoalMetricRequest.  # noqa: E501
        :type: str
        """
    ...
    def resource_subtype(self):
        """Gets the resource_subtype of this GoalMetricRequest.  # noqa: E501
        ...
        :return: The resource_subtype of this GoalMetricRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def resource_subtype(self, resource_subtype):
        """Sets the resource_subtype of this GoalMetricRequest.

        The subtype of this resource. Different subtypes retain many of the same fields and behavior, but may render differently in Asana or represent resources with different semantic meaning.  # noqa: E501

        :param resource_subtype: The resource_subtype of this GoalMetricRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def precision(self):
        """Gets the precision of this GoalMetricRequest.  # noqa: E501
        ...
        *Conditional*. Only relevant for goal metrics of type ‘Number’. This field dictates the number of places after the decimal to round to, i.e. 0 is integer values, 1 rounds to the nearest tenth, and so on. Must be between 0 and 6, inclusive. For percentage format, this may be unintuitive, as a value of 0.25 has a precision of 0, while a value of 0.251 has a precision of 1. This is due to 0.25 being displayed as 25%.  # noqa: E501
        ...
        :return: The precision of this GoalMetricRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def precision(self, precision):
        """Sets the precision of this GoalMetricRequest.

        *Conditional*. Only relevant for goal metrics of type ‘Number’. This field dictates the number of places after the decimal to round to, i.e. 0 is integer values, 1 rounds to the nearest tenth, and so on. Must be between 0 and 6, inclusive. For percentage format, this may be unintuitive, as a value of 0.25 has a precision of 0, while a value of 0.251 has a precision of 1. This is due to 0.25 being displayed as 25%.  # noqa: E501

        :param precision: The precision of this GoalMetricRequest.  # noqa: E501
        :type: int
        """
    ...
    @property
    def unit(self):
        """Gets the unit of this GoalMetricRequest.  # noqa: E501

        A supported unit of measure for the goal metric, or none.  # noqa: E501

        :return: The unit of this GoalMetricRequest.  # noqa: E501
        :rtype: str
        """
        return self._unit
    ...
    @unit.setter
    def unit(self, unit):
        """Sets the unit of this GoalMetricRequest.

        A supported unit of measure for the goal metric, or none.  # noqa: E501

        :param unit: The unit of this GoalMetricRequest.  # noqa: E501
        :type: str
        """
    ...
    def currency_code(self):
        """Gets the currency_code of this GoalMetricRequest.  # noqa: E501

        ISO 4217 currency code to format this custom field. This will be null if the `unit` is not `currency`.  # noqa: E501

        :return: The currency_code of this GoalMetricRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def currency_code(self, currency_code):
        """Sets the currency_code of this GoalMetricRequest.

        ISO 4217 currency code to format this custom field. This will be null if the `unit` is not `currency`.  # noqa: E501

        :param currency_code: The currency_code of this GoalMetricRequest.  # noqa: E501
        :type: str
        """
    ...
    def initial_number_value(self):
        """Gets the initial_number_value of this GoalMetricRequest.  # noqa: E501

        This number is the start value of a goal metric of type number.  # noqa: E501

        :return: The initial_number_value of this GoalMetricRequest.  # noqa: E501
        :rtype: float
        """
    ...
    def initial_number_value(self, initial_number_value):
        """Sets the initial_number_value of this GoalMetricRequest.

        This number is the start value of a goal metric of type number.  # noqa: E501

        :param initial_number_value: The initial_number_value of this GoalMetricRequest.  # noqa: E501
        :type: float
        """
    ...
    def target_number_value(self):
        """Gets the target_number_value of this GoalMetricRequest.  # noqa: E501

        This number is the end value of a goal metric of type number. This number cannot equal `initial_number_value`.  # noqa: E501

        :return: The target_number_value of this GoalMetricRequest.  # noqa: E501
        :rtype: float
        """
    ...
    def target_number_value(self, target_number_value):
        """Sets the target_number_value of this GoalMetricRequest.

        This number is the end value of a goal metric of type number. This number cannot equal `initial_number_value`.  # noqa: E501

        :param target_number_value: The target_number_value of this GoalMetricRequest.  # noqa: E501
        :type: float
        """
    ...
    def current_number_value(self):
        """Gets the current_number_value of this GoalMetricRequest.  # noqa: E501

        This number is the current value of a goal metric of type number.  # noqa: E501

        :return: The current_number_value of this GoalMetricRequest.  # noqa: E501
        :rtype: float
        """
    ...
    def current_number_value(self, current_number_value):
        """Sets the current_number_value of this GoalMetricRequest.

        This number is the current value of a goal metric of type number.  # noqa: E501

        :param current_number_value: The current_number_value of this GoalMetricRequest.  # noqa: E501
        :type: float
        """
    ...
    def current_display_value(self):
        """Gets the current_display_value of this GoalMetricRequest.  # noqa: E501

        This string is the current value of a goal metric of type string.  # noqa: E501

        :return: The current_display_value of this GoalMetricRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def current_display_value(self, current_display_value):
        """Sets the current_display_value of this GoalMetricRequest.

        This string is the current value of a goal metric of type string.  # noqa: E501

        :param current_display_value: The current_display_value of this GoalMetricRequest.  # noqa: E501
        :type: str
        """
    ...
    def progress_source(self):
        """Gets the progress_source of this GoalMetricRequest.  # noqa: E501
        ...
        :return: The progress_source of this GoalMetricRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def progress_source(self, progress_source):
        """Sets the progress_source of this GoalMetricRequest.

        This field defines how the progress value of a goal metric is being calculated. A goal's progress can be provided manually by the user, calculated automatically from contributing subgoals or projects, or managed by an integration with an external data source, such as Salesforce.  # noqa: E501

        :param progress_source: The progress_source of this GoalMetricRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GoalMetricRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GoalMetricRequest):
            return False
