...
class TaskRemoveFollowersRequest(object):
    ...
    def __init__(self, followers=None):  # noqa: E501
        """TaskRemoveFollowersRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def followers(self):
        """Gets the followers of this TaskRemoveFollowersRequest.  # noqa: E501

        An array of strings identifying users. These can either be the string \"me\", an email, or the gid of a user.  # noqa: E501

        :return: The followers of this TaskRemoveFollowersRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskRemoveFollowersRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskRemoveFollowersRequest):
            return False
