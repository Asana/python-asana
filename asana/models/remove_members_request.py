...
class RemoveMembersRequest(object):
    ...
    def __init__(self, members=None):  # noqa: E501
        """RemoveMembersRequest - a model defined in Swagger"""  # noqa: E501
        self._members = None
    ...
    @property
    def members(self):
        """Gets the members of this RemoveMembersRequest.  # noqa: E501

        An array of strings identifying users. These can either be the string \"me\", an email, or the gid of a user.  # noqa: E501

        :return: The members of this RemoveMembersRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RemoveMembersRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RemoveMembersRequest):
            return False
