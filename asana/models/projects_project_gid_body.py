...
class ProjectsProjectGidBody(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """ProjectsProjectGidBody - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProjectsProjectGidBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProjectsProjectGidBody):
            return False
