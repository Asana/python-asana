...
class _StatusUpdates:
    ...
    def delete_status(self, status_update_gid, params=None, **options):
        """Delete a status update
        :param str status_update_gid: (required) The status update to get.
        :param Object params: Parameters for the request
        :param **options
            - opt_pretty {bool}:  Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.
        :return: Object
        ...
        if params is None:
            params = {}
        path = "/status_updates/{status_update_gid}".replace("{status_update_gid}", status_update_gid)
        return self.client.delete(path, params, **options)

    def get_status(self, status_update_gid, params=None, **options):
        """Get a status update
        :param str status_update_gid: (required) The status update to get.
        :param Object params: Parameters for the request
        :param **options
