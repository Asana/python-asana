...
class _TeamMemberships:
    ...
    def get_team_membership(self, team_membership_path_gid, params={}, **options):
        """Get a team membership
        :param str team_membership_path_gid: (required)
        ...
        :return: Object
        """
        path = "/team_memberships/{team_membership_gid}".replace("{team_membership_path_gid}", team_membership_path_gid)
        return self.client.get(path, params, **options)


    def get_team_memberships(self, params={}, **options):
    ...
    def get_team_memberships_for_team(self, team_gid, params={}, **options):
    ...
    def get_team_memberships_for_user(self, user_gid, params={}, **options):
